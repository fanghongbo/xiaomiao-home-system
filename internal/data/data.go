...
var ProviderSet = wire.NewSet(NewData, NewGID, NewDB, NewRDB, NewUserRepo, NewRoleRepo, NewPublishRepo, NewUserNotificationRepo, NewUserSettingRepo, NewFileRepo, NewCollectRepo)
