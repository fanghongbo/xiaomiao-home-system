...
var ProviderSet = wire.NewSet(NewData, NewGID, NewDB, NewRDB, NewUserRepo, NewRoleRepo, NewPostRepo, NewUserNotificationRepo, NewUserSettingRepo, NewFileRepo, NewCollectRepo, NewDiscoverRepo, NewCatRepo)
