...
type UserInfo struct {
	...
	Roles         []*RoleItem            `protobuf:"bytes,5,rep,name=roles,proto3" json:"roles,omitempty"`
...
const file_api_user_v1_user_proto_rawDesc = "" +
	...
	"\x05roles\x18\x05 \x03(\v2\x15.api.user.v1.RoleItemR\x05roles\x12\x16\n" +
	"\x06status\x18\x06 \x01(\x03R\x06status2b\n" +
	"\x04User\x12Z\n" +
...
var file_api_user_v1_user_proto_depIdxs = []int32{
	...
	6, // 2: api.user.v1.UserInfo.roles:type_name -> api.user.v1.RoleItem
	2, // 3: api.user.v1.User.Login:input_type -> api.user.v1.LoginRequest
	5, // 4: api.user.v1.User.Login:output_type -> api.user.v1.LoginReply
