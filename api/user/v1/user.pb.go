...
const (
	...
	LoginType_LOGIN_TYPE_ACCOUNT     LoginType = 1 // 账号密码
	LoginType_LOGIN_TYPE_EMAIL       LoginType = 2 // 邮箱登录（密码或验证码，按业务约定）
	LoginType_LOGIN_TYPE_SMS         LoginType = 3 // 手机验证码
	LoginType_LOGIN_TYPE_WECHAT      LoginType = 4 // 微信授权
	LoginType_LOGIN_TYPE_QQ          LoginType = 5 // QQ授权
)
...
const file_api_user_v1_user_proto_rawDesc = "" +
	...
	"\fMpLoginReply*\x93\x01\n" +
	"\tLoginType\x12\x1a\n" +
	"\x16LOGIN_TYPE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12LOGIN_TYPE_ACCOUNT\x10\x01\x12\x14\n" +
	"\x10LOGIN_TYPE_EMAIL\x10\x02\x12\x12\n" +
	"\x0eLOGIN_TYPE_SMS\x10\x03\x12\x15\n" +
	"\x11LOGIN_TYPE_WECHAT\x10\x04\x12\x11\n" +
	"\rLOGIN_TYPE_QQ\x10\x052\xbd\x02\n" +
	"\x04User\x12g\n" +
	...
	"\aMpLogin\x12\x1b.api.user.v1.MpLoginRequest\x1a\x19.api.user.v1.MpLoginReply\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/api/v1/mp/auth/loginBA\n" +
...
var file_api_user_v1_user_proto_depIdxs = []int32{
	...
	3,  // 2: api.user.v1.User.WebLogin:input_type -> api.user.v1.WebLoginRequest
	9,  // 3: api.user.v1.User.AppLogin:input_type -> api.user.v1.AppLoginRequest
	11, // 4: api.user.v1.User.MpLogin:input_type -> api.user.v1.MpLoginRequest
	5,  // 5: api.user.v1.User.WebLogin:output_type -> api.user.v1.WebLoginReply
	10, // 6: api.user.v1.User.AppLogin:output_type -> api.user.v1.AppLoginReply
	12, // 7: api.user.v1.User.MpLogin:output_type -> api.user.v1.MpLoginReply
